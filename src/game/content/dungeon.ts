...
export const dungeon = {
  ...
  roomHalfSize: 370, gateRadius: 55, bossVulnerable: 6,
  rooms: [
    ...
    { name: 'The Anchored Core', instruction: 'Hold Pull or Discharge near the boss to break its anchor. Then melee the exposed vessel.', center: { x: 1500, y: 1500 }, enemies: ['guardian'] as Kind[], masses: [110], offsets: [{x: 200, y: 0}], gate: { x: 1780, y: 1500 }, obstacles: [{x: 1470, y: 1280, radius: 40}, {x: 1540, y: 1720, radius: 40}], hazard: null },
  ],
